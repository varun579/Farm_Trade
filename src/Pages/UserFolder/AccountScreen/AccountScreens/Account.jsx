  ...
  return (
    <View style={{backgroundColor:'white',marginHorizontal:10, flex:1}}>
       ...
       /> : <Image
        ...
        <TouchableOpacity style={styles.wallet} onPress={()=>navigation.navigate('Wallet',{wallet:wallet})}>
          ...
          <View style={styles.body}>
            ...
            <TouchableOpacity style={styles.bodybox} onPress={()=>navigation.navigate('Profile',{data:userData})}>
            ...
            <TouchableOpacity style={styles.bodybox} onPress={()=>navigation.navigate('Addreses')}>
            ...
            <TouchableOpacity style={styles.bodybox} onPress={()=>navigation.navigate('Orders')}>
            ...
            <TouchableOpacity style={styles.bodybox} onPress={()=>navigation.navigate('Wishlist')}>

            <View style={styles.boxes}>
              <Sicon name='heart' size={25} color='green'/>
              <Text style={{fontSize:18, color:'black',marginLeft:20}}>Wishlist</Text>
            </View>
            <Icons name='chevron-right' size={28} color='green' style={{marginHorizontal:10}}/>
